/*
This file implements a standalone command-line interface (CLI)
for running the benchmark framework without Python.

Purpose:
--------
It allows the benchmark to be executed directly from the command line,
which is useful for:
- quick testing
- debugging
- running benchmarks on remote systems or clusters
- scripting via shell tools

This file:
- parses command-line arguments
- constructs a benchmark configuration
- instantiates the selected queue implementation
- executes the benchmark
- prints results in CSV format to stdout

Why this file is necessary:
---------------------------
While Python provides flexibility, a standalone C++ binary is often
required for:
- automated cluster runs (e.g., SLURM jobs)
- environments without Python
- precise performance isolation

This file ensures that the benchmark framework can be used both as
a library (via Python bindings) and as an independent executable.
*/
